...
class Ui_DetailDialog(object):
    def setupUi(self, DetailDialog):
        ...
        self.textVotes = QtWidgets.QLineEdit(DetailDialog)
        self.textVotes.setObjectName("textVotes")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.textVotes)
        ...
        DetailDialog.setTabOrder(self.textState, self.textChamber)
        DetailDialog.setTabOrder(self.textChamber, self.textParty)
        DetailDialog.setTabOrder(self.textParty, self.textVotes)
        DetailDialog.setTabOrder(self.textVotes, self.textBirthday)
        DetailDialog.setTabOrder(self.textBirthday, self.textPhone)
        DetailDialog.setTabOrder(self.textPhone, self.textAddress)
    ...
    def retranslateUi(self, DetailDialog):
        ...
        self.label.setText(_translate("DetailDialog", "Missed Votes %"))
